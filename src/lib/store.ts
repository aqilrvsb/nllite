...
// A Leader / Director / flagged team-lead manages a team (staff whose leader_id points to them).
export function isLeader(user: { role?: string; is_admin: boolean; is_manager?: boolean }): boolean {
